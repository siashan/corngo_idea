...
function menuItem() {
    ...
    if (flag) {
        ...
        // 添加选项卡对应的iframe
        var str1 = '<iframe  onload="this.height=this.contentWindow.document.documentElement.scrollHeight" class="J_iframe" name="iframe' + dataIndex + '" width="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
...
//    });
    ...
    if(isNew || flag){//isNew为true，打开一个新的选项卡； flag为true，选项卡不存在，打开一个新的选项卡。
	        ...
	        // 添加选项卡对应的iframe
	        var str1 = '<iframe disp  onload="this.height=this.contentWindow.document.documentElement.scrollHeight" class="J_iframe" name="iframe' + dataIndex + '" width="100%"  src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
