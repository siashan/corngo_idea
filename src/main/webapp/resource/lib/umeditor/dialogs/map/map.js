(function () {
    ...
    UM.registerWidget(widgetName, {
        ...
        tpl: "<style type=\"text/css\">" +
            ...
            "<td style='display: none'><label class=\"edui-map-dynamic-label\"><input class=\"edui-map-dynamic\" type=\"checkbox\"  checked name=\"edui-map-dynamic\" /><span><%=lang_dynamicmap%></span></label></td>"+
            "</tr>" +
            "</table>" +
